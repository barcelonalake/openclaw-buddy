...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  onStateChange: (callback) => ipcRenderer.on("state-change", (_, state, svg, healthState) => callback(state, svg, healthState)),
  ...
  onHealthChange: (callback) => ipcRenderer.on("health-change", (_, healthState) => callback(healthState)),
